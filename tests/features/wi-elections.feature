Feature: WI Elections
  ...
  Examples: 20050405__wi__general__ward.csv
    | party | candidate                     | county    | office                                    | district  | ward                                          | votes | total |
    | NP    | Paul B. Higginbotham          | Wood      | Court of Appeals                          | 4         | TOWN OF SENECA Wards 1 - 3                    | 90    | 90    |

  Examples: 20051213__wi__special__primary__ward.csv
    | party | candidate                     | county    | office                                    | district  | ward                                          | votes | total |
    | DEM   | Patrick Byrne                 | Waukesha  | State Assembly                            | 33        | VILLAGE OF MUKWONAGO Ward 10                  | 0     | 0     |
    | REP   | Kent D. Woods                 | Waukesha  | State Assembly                            | 33        | TOWN OF WAUKESHA Wards 3, 7 & 8               | 21    | 154   |
  ...
  Examples: 20080909__wi__primary__ward.csv
    ...
    | WGR   | Scattering                    | Dane      | State Senate                              | 16        | CITY OF MADISON Ward 7                        | 2     | 2     |
    | WGR   | Scattering                    | Winnebago | House                                     | 6         | CITY OF OSHKOSH Ward 33                       | 6     | 6     |
    | DEM   | Tara Johnson                  | La Crosse | State Senate                              | 32        | TOWN OF SHELBY Wards 1, 4 - 6                 | 38    | 38    |
    | IND   | Clyde Winter                  | Ozaukee   | State Senate                              | 20        | CITY OF MEQUON Ward 2                         | 1     | 1     |
    | DEM   | Mark Wollum                   | Dodge     | House                                     | 6         | CITY OF WAUPUN Wards 1 - 3 & 8                | 9     | 28    |
    | LIB   | Joseph Kexel                  | Kenosha   | House                                     | 1         | TOWN OF SALEM Wards 1, 7, 11 - 15             | 8     | 8     |
    | LIB   | Kevin Barrett                 | Crawford  | House                                     | 3         | TOWN OF UTICA                                 | 3     | 3     |
    | REP   | Chad Fradette                 | Brown     | State Senate                              | 30        | CITY OF GREEN BAY Ward 7                      | 44    | 45    |
    | REP   | Paul Stark                    | Buffalo   | House                                     | 3         | TOWN OF MAXVILLE                              | 19    | 19    |
    | DEM   | Christopher Baeb              | Door      | State Assembly                            | 1         | TOWN OF SEVASTOPOL Wards 1 - 3                | 39    | 197   |
    | REP   | Garey Bies                    | Brown     | State Assembly                            | 1         | TOWN OF SCOTT Wards 1 - 4                     | 47    | 47    |
  ...
  Examples: 20100914__wi__primary__ward.csv
    ...
    | LIB   | Joseph Kexel                  | Kenosha   | House                                     | 1         | VILLAGE OF PLEASANT PRAIRIE Wards 6 & 7       | 2     | 2     |
  ...
  Examples: 20110712__wi__primary-recall__ward.csv
    ...
    | DEM   | ISAAC WEIX                    | Dunn      | State Senate                              | 10        | CITY OF MENOMONIE MENOMONIE CITY WARD 6       | 70    | 279   |
    | DEM   | ROL CHURCH                    | Fond Du Lac| State Senate                             | 14        | TOWN OF RIPON Wards 1 & 2                     | 117   | 235   |
    | DEM   | JOHN D. BUCKSTAFF             | Dodge     | State Senate                              | 18        | CITY OF WAUPUN Wards 1 - 8                    | 167   | 738   |
    | DEM   | JENNIFER SHILLING             | La Crosse | State Senate                              | 32        | CITY OF LA CROSSE Ward WD20                   | 1     | 1     |
  ...
  Examples: 20121106__wi__general__ward.csv
    ...
    | REP   | Sheila Harsdorf               | Polk      | State Senate                              | 10        | Town of Laketown Ward 1                       | 316   | 542   |
  ...
  Examples: 20121106__wi__special__primary__ward.csv
    | party | candidate                     | county    | office                                    | district  | ward                                          | votes | total |
    | REP   | Paul Farrow                   | Waukesha  | State Senate                              | 33        | VILLAGE OF OCONOMOWOC LAKE WARD 1             | 144   | 244   |
  ...
  Examples: 20140812__wi__primary__ward.csv
    ...
    | REP   | Paul Ryan                     | Kenosha   | House                                     | 1         | CITY OF KENOSHA WARD87                        | 66    | 77    |
    | REP   | Reid J. Ribble                | Winnebago | House                                     | 8         | TOWN OF WOLF RIVER Wards 2B and 2C            | 22    | 22    |
    | DEM   | Kathleen Vinehout             | Trempealeau| State Senate                             | 31        | VILLAGE OF ETTRICK Ward 1                     | 79    | 79    |
    | REP   | Dane Deutsch                  | Douglas   | State Senate                              | 25        | CITY OF SUPERIOR Wards 23 - 26 and 27 - 29    | 81    | 81    |
    | CON   | Scattering                    | Sauk      | State Senate                              | 27        | TOWN OF PRAIRIE DU SAC WARDS 1-2, COMBINED    | 0     | 0     |
    | DEM   | Daniel Riemer                 | Milwaukee | State Assembly                            | 7         | VILLAGE OF WEST MILWAUKEE WARDS - 1, 2 & 5    | 94    | 94    |
  ...
  Examples: 20171219__wi__special__primary__ward.csv
    ...
    | REP   | Shannon Zimmerman             | St. Croix | State Senate                              | 10        | Town of CYLON Ward 1                          | 11    | 40    |
  ...
  Examples: 20180814__wi__primary__ward.csv
    | party | candidate                     | county    | office                                    | district  | ward                                          | votes | total |
    | DEM   | Gary R. George                | Milwaukee | House                                     | 4         | City of MILWAUKEE Ward 87                     | 126   | 151   |
    | REP   | Tyler August                  | Racine    | State Assembly                            | 32        | Town of Burlington Wards 8-10                 | 159   | 160   |
    | LIB   | Mike Hammond                  | Brown     | State Assembly                            | 6         | Village of Pulaski Wards 1-3,6                | 1     | 1     |
    | REP   | André Jacque                  | Door      | State Senate                              | 1         | City of STURGEON BAY Wards 7-10,18-21,25 -27,30| 142  | 201   |
    | DEM   | Richard Pulcher               | Wood      | State Senate                              | 29        | City of MARSHFIELD Wards 8,19,22-23           | 130   | 130   |
    | REP   | Griffin Jones                 | Washington| Senate                                    |           | Town of HARTFORD Wards 1-5                    | 10    | 640   |
    | REP   | Adam Nicholas Paul (Write-In) | Outagamie | Governor                                  |           | Town of GRAND CHUTE Wards 15-17               | 1     | 483   |
    | DEM   | SCATTERING                    | Buffalo   | Governor                                  |           | City of BUFFALO CITY Ward 1                   | 1     | 115   |
    | WGR   | Michael J. White              | Pierce    | Governor                                  |           | City of RIVER FALLS Wards 6-8                 | 1     | 1     |
    | DEM   | Mandela Barnes                | Kenosha   | Lieutenant Governor                       |           | City of KENOSHA Ward 22                       | 129   | 229   |
